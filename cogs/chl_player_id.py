...
class chl_player_id(commands.Cog):
    ...
    @chl_player_id_group.command(name="attributes", description="Look up a college hockey player using a player {id}")
    ...
    @chl_player_id_group.command(name="stats", description="Look up a college hockey player using a player {id}")
...
async def setup(client: commands.Bot):
    await client.add_cog(chl_player_id(client))
