...
class phl_player_name(commands.Cog):
    ...
    @phl_player_name_group.command(name="attributes", description="Look up a PHL player using a {first name}, {last name}, and {team}")
    ...
    @phl_player_name_group.command(name="stats", description="Look up a profesional hockey player using a {first name}, {last name}, and {team}")
...
async def setup(client: commands.Bot):
    await client.add_cog(phl_player_name(client))
