...
class nfl_player_name(commands.Cog):
    ...
    @nfl_player_name_group.command(name="attributes", description="Look up a profesional football player using a {first name}, {last name}, and {team}")
    ...
    @nfl_player_name_group.command(name="stats", description="Look up a profesional football player using a {first name}, {last name}, and {team}")
...
async def setup(client: commands.Bot):
    await client.add_cog(nfl_player_name(client))
