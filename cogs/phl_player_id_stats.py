...
class phl_player_id_stats(commands.Cog):
    def __init__(self, client: commands.Bot):
        self.client = client
    @app_commands.command(name="phl_player_id_stats", description="Look up a profesional hockey player using a player {id}")
    async def phl_player_id_stats(self, interaction: discord.Interaction, id: str):
        try:
...
async def setup(client: commands.Bot):
    await client.add_cog(phl_player_id_stats(client))
