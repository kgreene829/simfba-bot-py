...
class cfb_player_id_career_stats(commands.Cog):
    def __init__(self, client: commands.Bot):
        self.client = client
    @app_commands.command(name="cfb_player_id_career_stats", description="Look up a college football player using a player {id}")
    async def cfb_player_id_career_stats(self, interaction: discord.Interaction, id: str):
        try:
...
async def setup(client: commands.Bot):
    await client.add_cog(cfb_player_id_career_stats(client))
