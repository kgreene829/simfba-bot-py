...
from helper import nfl_stream_builder
import settings
...
class NFL_Live_Stream(commands.Cog):
    ...
    async def a(self, interaction: discord.Integration, input: str):
        ...
        await nfl_stream_builder.stream_game(chan, 'Thursday Night', input)
    ...
    async def a(self, interaction: discord.Integration, input: str):
        ...
        await nfl_stream_builder.stream_game(chan, 'Sunday Noon', input)
    ...
    async def b(self, interaction: discord.Integration, input: str):
        ...
        await nfl_stream_builder.stream_game(chan, 'Sunday Afternoon', input)
    ...
    async def c(self, interaction: discord.Integration, input: str):
        ...
        await nfl_stream_builder.stream_game(chan, 'Sunday Night', input)
    ...
    async def d(self, interaction: discord.Integration, input: str):
        ...
        await nfl_stream_builder.stream_game(chan, 'Monday Night', input)
